<template>
	<div>
	    <Button type="primary" v-on:click="toAdd">添加员工</Button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // },
			show(index){
				console.log("id的值为！！！！！！！！！"+this.data6[index].id)
				
				this.$router.push({path:'/employeeDetail',query:{id:this.data6[index].id}});
			},
			...
			toAdd:function(){
				this.$router.replace('/addEmployee')
			}
